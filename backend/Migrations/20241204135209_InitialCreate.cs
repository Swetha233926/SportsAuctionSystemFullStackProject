        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuctionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AuctionName = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformanceStats = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tournament = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PerformanceDetails = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AnalystId = table.Column<int>(type: "int", nullable: false),
                    Rating = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerformanceReports", x => x.ReportId);
                    table.ForeignKey(
                        name: "FK_PerformanceReports_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "PlayerId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PerformanceReports_Users_AnalystId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuctionResults", x => x.ResultId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuctionResults_Teams_WinningTeamId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuctionResults_WinningTeamId",
                table: "AuctionResults",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerformanceReports_AnalystId",
                table: "PerformanceReports",
                column: "AnalystId");

            migrationBuilder.CreateIndex(
                name: "IX_PerformanceReports_PlayerId",
                table: "PerformanceReports",
                column: "PlayerId");
